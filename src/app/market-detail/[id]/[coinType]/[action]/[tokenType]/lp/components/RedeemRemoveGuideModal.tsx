...
export default function RedeemRemoveGuideModal() {
  return (
    <AlertDialog>
        ...
        <div className="flex flex-col gap-y-8 items-center">
          ...
          <div className="text-left space-y-4 mb-6 text-sm max-w-[600px]">
            <p className="text-light-gray/40">
              Split LP tokens into PT and underlying assets in their native
              proportions without affecting the price.
            </p>

            <div className="space-y-3">
              <p className="text-light-gray/40">When to use Redeem & Remove:</p>
              <ul className="space-y-2 text-light-gray/40">
                <li className="flex items-start gap-2">
                  <span className="text-light-gray/40 mt-1">•</span>
                  <span>
                    If you want to retain a certain amount of fixed income when
                    removing without affecting the value of your assets.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-light-gray/40 mt-1">•</span>
                  <span>If you remove relatively many underlying assets.</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          {/* 流程图 */}
          <div className="w-[600px] py-[40px] flex justify-center">
            <div

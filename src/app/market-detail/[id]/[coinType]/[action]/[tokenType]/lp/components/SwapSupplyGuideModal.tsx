...
export default function SwapSupplyGuideModal() {
  return (
    <AlertDialog>
        ...
        <div className="flex flex-col gap-y-8 items-center">
          ...
          <div className="text-left space-y-4 mb-6 text-sm max-w-[600px]">
            <p className="text-light-gray/40">
              A portion of the liquidity supplied is used to buy PT, causing
          ...
          <div className="w-[900px] py-[40px] font-serif text-light-gray">
            ...
            >
              ...
              {/* 第2行: BALANCE + TOKEN SPLIT + + 号 + ADD LIQUIDITY + LP sSUI */}

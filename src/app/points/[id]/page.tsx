...
const vsuiTabs: TabItem[] = [
    {
        ...
        description: 'Boost your points by buying YT at a cost. Along with YTs leverage, you get Volo points multipliers.',
        additionalInfo: 'YT drops to zero at maturity, but you can exit anytime at its market price, keeping all earned points. These points can be redeemed for airdrop tokens at the season\'s end.',
    ...
    },
    {
        ...
        description: 'Accrue vSUI APY and trading fees from NEMO pools, while preserving a substantial portion of Volo points. LPs are granted a 2x multiplier on their Nemo points.',
    ...
    },
    {
        ...
        description: 'Secure a fixed APY on your deposits by swapping your Volo points. Each PT will be redeemable for 1 vSUI upon maturity.',
        additionalInfo: 'Although the fixed APY is realized at maturity, early exit is possible at the prevailing market price.',
...
const zlpTabs: TabItem[] = [
    {
        id: 'yt',
        title: 'YT-ZLP-250820',
        description: 'Boost your points by buying YT at a cost. Along with YTs leverage, you get ZO points multipliers.',
        additionalInfo: 'YT drops to zero at maturity, but you can exit anytime at its market price, keeping all earned points. These points can be redeemed for airdrop tokens at the season\'s end.',
    ...
    },
    {
        id: 'lp',
        title: 'LP-ZLP-250820',
        description: 'Accrue ZLP APY and trading fees from NEMO pools, while preserving a substantial portion of ZO Points. LPs are granted a 2x multiplier on their Nemo points.',
        additionalInfo: 'Withdrawals of your funds can be made at any time.',
    ...
    },
    {
        id: 'pt',
        title: 'PT-ZLP-250820',
        description: 'Secure a fixed APY on your deposits by swapping your ZO Points. Each PT will be redeemable for 1 ZLP Token upon maturity.',
        additionalInfo: 'Although the fixed APY is realized at maturity, early exit is possible at the prevailing market price.',
...
const sbusdtTabs: TabItem[] = [
    {
        ...
        description: 'Boost your points by buying YT at a cost. Along with YTs leverage, you get MMT points multipliers.',
        additionalInfo: 'YT drops to zero at maturity, but you can exit anytime at its market price, keeping all earned points. These points can be redeemed for airdrop tokens at the season\'s end.',
    ...
    },
    {
        ...
        description: 'Accrue sbUSDT APY and trading fees from NEMO pools, while preserving a substantial portion of MMT Points. LPs are granted a 2x multiplier on their Nemo points.',
        additionalInfo: 'Withdrawals of your funds can be made at any time.',
    ...
    },
    {
        ...
        description: 'Secure a fixed APY on your deposits by swapping your MMT Points. Each PT will be redeemable for 1 sbUSDT upon maturity.',
        additionalInfo: 'Although the fixed APY is realized at maturity, early exit is possible at the prevailing market price.',
...
const vsuiProjectData = {
    ...
    description: 'Determine Your Priority: Amplify Points, Enhance Yields, Or Attain a Balanced Blend.',
    multipliers: {
        volo: '2x',
        nemo: '2x'
    },
...
export default function PointsDetailPage({ params }: { params: { id: string } }) {
    ...
    return (
        <div className="bg-[#080d16] text-white min-h-screen p-6">
            ...
            <div className="mb-12">
                <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center gap-6">
                        <img src={projectData.icon} alt={projectData.name} className="w-12 h-12" />
                        <div>
                            <div className="flex gap-2 mb-1">
                                ...
                                <div className="flex items-start gap-2">
                                    ...
                                    <img src="/points/share.svg" alt="share" className="w-4 h-4" />
                                </div>
                            </div>
                            <p
                                className="max-w-3xl"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                {allTabs[params.id as keyof typeof allTabs].map((tab, index) => (
                    <div
                        key={tab.id}
                    ...
                    >
                        <div className="relative w-12 h-12 mb-4">
                            <img src={tab.icon} alt={tab.title} className="w-[60px] h-[60px]" />
                        </div>
                        ...
                        >
                            <img src="/points/$.svg" alt="buy" className="w-4 h-4" />
                            {tab.id === 'yt' ? 'Buy YT' : tab.id === 'lp' ? 'Provide Liquidity' : 'Buy PT'}
                        </button>
                    </div>
                ))}
            </div>
